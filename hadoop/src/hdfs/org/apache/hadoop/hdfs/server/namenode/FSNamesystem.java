...
public class FSNamesystem implements FSConstants, FSNamesystemMBean,
    ...
    //ReplicationTargetChooser replicator;// comment out for elf
    DatacenterAwareTargetChooser replicator;
    ...
    private void initialize(NameNode nn, Configuration conf) throws IOException {
        ...
        */
        this.dnsToSwitchMapping = ReflectionUtils.newInstance(
                conf.getClass("topology.node.switch.mapping.impl", SDNTopologyManager.class,
                        DNSToSwitchMapping.class), conf);
    ...
    private void setConfigurationParameters(Configuration conf)
        ...
        this.replicator = new DatacenterAwareTargetChooser(
