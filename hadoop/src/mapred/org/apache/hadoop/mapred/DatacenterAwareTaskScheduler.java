...
public class DatacenterAwareTaskScheduler extends TaskScheduler {

    private static final int MIN_CLUSTER_SIZE_FOR_PADDING = 3;
    public static final Log LOG = LogFactory.getLog(DatacenterAwareTaskScheduler.class);
    ...
    public DatacenterAwareTaskScheduler() {
