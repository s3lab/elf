...
public class TaskTrackerStatus implements Writable {
    ...
    List<String> completePrefetchReport;
    ...
    public TaskTrackerStatus() {
        ...
        //for elf
        this.completePrefetchReport = new ArrayList<String>();
    }
    ...
    public void write(DataOutput out) throws IOException {
        ...
        // Code block for elf
        //
        out.writeInt(availablePrefetchSlot);
        out.writeInt(completePrefetchReport.size());
        for(String s: completePrefetchReport){
            out.writeUTF(s);
        }
    }
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        // Code block for elf
        //
        availablePrefetchSlot = in.readInt();
        int numPrefetchReport = in.readInt();
        this.completePrefetchReport = new ArrayList<String>();
        for (int i = 0; i < numPrefetchReport; i++) {
            completePrefetchReport.add(in.readUTF());
        }
    }
    ...
    // for now, use static number, but it's easy to extend it to be configurable
    private int availablePrefetchSlot = 0;
    public int getAvailablePrefetchSlot(){
        return availablePrefetchSlot;
    }
    public void setAvailablePrefetchSlot(int pSlot){
        this.availablePrefetchSlot = pSlot;
    }

    public void setCompletePrefetchReport(List<String> report){
        this.completePrefetchReport = report;
    }
    public List<String> getCompletePrefetchReport(){
        return this.completePrefetchReport;
    }
}
